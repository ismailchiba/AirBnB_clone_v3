...
print("waiting for the next execution of similar objects in \
      a different  format!")
time.sleep(1)
print("wait a second!")
time.sleep(3)

# error handler for the MySQLdb existence(it had issues on my local
# machine, so dontr pay attention to this snippet)
try:
    import MySQLdb
...
print("First state: {}".format(storage.get(State, \
        first_state_id)))"""
