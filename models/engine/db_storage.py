...
class DBStorage:
    ...
    def get(self, cls, id):
        ...
        Args:
            cls (str): The name of the class or None for all classes
            id (str): The id of the object or None for all objects
    ...
    def count(self, cls=None):
        ...
        Returns:
            int: The occurrence of the class or all classes
        """
        occurrence = 0
        if cls:
