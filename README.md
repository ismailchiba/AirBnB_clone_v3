...
So in this project, we will be modifying the AirBnB Clone codebase to include RESTful APIs. We are going to write RESTful APIs that interactively work with the Application to ensure that this concept is greatliy implemented.

Below are the specific resources where to get information and understand how REST APIs can e created and used.

- [Designing a RESTful API with Python and Flask] (https://blog.miguelgrinberg.com/post/designing-a-restful-api-with-python-and-flask)
- [HTTP access control CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS)
- [Flask cheatsheet](https://intranet.alxswe.co)
...
Third Version desgin of Airbnb: Evans Manyala
