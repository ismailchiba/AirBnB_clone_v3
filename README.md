...
| 11. Reviews | [api/v1/views/places_reviews.py, api/v1/views/__init__.py](https://github.com/Willys12/AirBnB_clone_v3.git) | create a new view for Review object that handles all default RESTFul API actions, Retrieves the list of all Review objects of a Place: GET /api/v1/places/<place_id>/reviews, Retrieves a Review object. : GET /api/v1/reviews/<review_id>, Deletes a Review object: DELETE /api/v1/reviews/<review_id>, Creates a Review: POST /api/v1/places/<place_id>/reviews & <b>Updates</b> a Review object: PUT /api/v1/reviews/<review_id> |
