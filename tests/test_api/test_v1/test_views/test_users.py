#!/usr/bin/python3
'''script that tests the index route'''
import unittest
import pep8
...
class TestUsers(unittest.TestCase):
    ...
    def test_lists_users(self):
        '''script that test user GET route'''
    ...
    def test_create_user(self):
        '''script that test user POST route'''
        with app.test_client() as c:
    ...
    def test_get_user(self):
        '''script that test user GET by id route'''
        with app.test_client() as c:
            new_user = User(first_name="Mojo", last_name="Jojo",
                            email="123@abc.com", password="0000")
            storage.new(new_user)
    ...
    def test_update_user(self):
        '''script that test user PUT route'''
        with app.test_client() as c:
            new_user = User(first_name="Mojo", last_name="Jojo",
                            email="123@abc.com", password="0000")
            storage.new(new_user)
