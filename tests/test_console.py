...
def test_create(self, mock_stdout):
    ...
    This test ensures that using the 'create' command with the 'State' class and
    ...
    def test_all(self, mock_stdout):
        ...
        This test verifies that after creating a new 'State' object, calling the
        'all' command with 'State' as an argument lists all instances of the State class,
    ...
    def test_show(self, mock_stdout):
        ...
        This test checks that after creating a 'State' object, using the 'show' command
