...
class TestDBStorageDocs(unittest.TestCase):
    """Test documentation strings for DBStorage methods"""
    ...
    def test_doc_class(self):
        """Tset documentation for DBStorage class"""
    ...
    def test_doc_reload(self):
        """Test documentation for reload() function"""
...
class TestStateDBInstances(unittest.TestCase):
    ...
    def test_state_all(self):
        """Check if all() function returns newly created instance"""
...
class TestUserDBInstances(unittest.TestCase):
    ...
    def test_user_all(self):
        """Checks if all() function returns newly created User instance"""
        all_objs = storage.all()
...
class TestCityDBInstances(unittest.TestCase):
    """Testing for City class instances"""
    ...
    def setUp(self):
        """Initializes new City object for testing"""
        self.state = State()
        self.state.name = 'California'
        self.state.save()
        self.city = City()
