...
class TestStorageCount(unittest.TestCase):
    ...
    def setup(self):
        ...
        setup method
        """
        self.state1 = State(name="osun")
        self.state1.save()
        self.state2 = State(name="Oyo")
        self.state2.save()
        self.state3 = State(name="Enugu")
        self.state3.save()
        self.state4 = State(name="Bayelsa")
        self.state4.save()
        self.state5 = State(name="Ondo")
        self.state5.save()
        self.state6 = State(name="Nasarawa")
        self.state6.save()
        self.state7 = State(name="Kogi")
        self.state7.save()
